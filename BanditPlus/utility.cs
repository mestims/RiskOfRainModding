...
namespace EntityStates.Bandit
{
    public class Utility : BaseState
    {
        public static void SetUtility(GameObject gameObject)
        {
            ...
            SkillManagement.SetSkill(ref skillslot, typeof(Utility));
        ...
        {
            return SkillManagement.configfloat(nameof(Utility), field, defaultvalue, out value);
        }
